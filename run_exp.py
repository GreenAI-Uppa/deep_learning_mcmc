...
st_prop = stats.Student(student_variance, 0)
...
for t in range(epochs):
    ...
    if use_gradient:
        ...
        acceptance_ratio = optimizers.train_1_epoch(train_dataloader, model, loss_fn, prior=st, proposal=st_prop, lamb=lamb, iter_mcmc=iter_mcmc)
