...
#model = nets.MLP(layer_sizes, activations='Softmax')
...
selector = utils.LinearSelector(model)
optimizer = optimizers.MCMCOptimizer(st_prop, iter_mcmc=50, lamb=10000000, prior=st_prior, selector=selector)
