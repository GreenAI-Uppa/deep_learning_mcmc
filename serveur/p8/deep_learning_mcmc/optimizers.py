...
class MCMCOptimizer(Optimizer):
    ...
    async def train_1_epoch(self, model, loss_fn, verbose=False, test_dataloader=None):
        """
    ...
    async def train_1_batch(self, X, y, model, loss_fn, verbose=False, test_dataloader=None):
        """
