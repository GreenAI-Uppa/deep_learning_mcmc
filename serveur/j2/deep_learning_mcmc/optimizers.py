...
class MCMCOptimizer(Optimizer):
    def __init__(self, sampler, data_points_max = 1000000000, iter_mcmc=1, lamb=1000,  prior=None, selector=None, pruning_level=0, reading_queue=None):
        """
    ...
    async def train_1_batch(self, X, y, model, dataloader, loss_fn, verbose=False):
        """
